...
#         print('---------------')
#         print('current node index:', current_node.index)
#         print('distance:', np.sqrt((current_node.x-park_map.case.xf)
#               ** 2 + (current_node.y - park_map.case.yf)**2))
#         print('---------------')
...
#             collision_p = info['collision_position']
#             plot_collision_p(
#                 collision_p[0], collision_p[1], collision_p[2], park_map)
...
#                 if config['collision_check'] == 'circle':
#                     collision = collision_check.two_circle_check(node_x=x_j,
#                                                                  node_y=y_j,
#                                                                  theta=theta_j,
#                                                                  map=park_map)
#                 else:
#                     collision = collision_check.distance_check(node_x=x_j,
#                                                                node_y=y_j,
#                                                                theta=theta_j,
#                                                                map=park_map,
#                                                                config=config)
